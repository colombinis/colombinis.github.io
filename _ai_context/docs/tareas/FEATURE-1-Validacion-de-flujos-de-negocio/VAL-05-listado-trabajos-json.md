...
F="_ai_context/docs/tareas/FEATURE-1-Validacion-de-flujos-de-negocio/listado-trabajos.html"
...
- La ruta `../../../src/data/trabajos/listado-trabajos.json` es relativa al
  HTML dentro de `_ai_context/docs/tareas/FEATURE-1-.../`; requiere servir el repo por HTTP.
