...
> Maestro global: `_ai_context/docs/tareas/TODO.md`.
> Metodología: SDD + BDD.

## Contexto

El proyecto no tenía una carpeta `tests/` a nivel raíz. Los pocos tests
existentes vivían sueltos en carpetas de tareas (`_ai_context/docs/tareas/FEATURE-1/...`)
...
|----|--------|--------|-----------|-------|
| UJ-01 | Definir 3 personas/clientes típicos | DONE (archived) | PyME sin web, PyME con WP roto, reclutador tech | `_ai_context/docs/tareas/UJ-01-definir-personas.md` |
| UJ-02 | Journey: PyME sin web → contacto | DONE (archived) | Recorrido landing → WhatsApp/contacto | `_ai_context/docs/tareas/UJ-02-journey-pyme-whatsapp.md` |
| UJ-03 | Journey: PyME con WP roto → rescate | DONE (archived) | Recorrido diagnóstico → propuesta rescate | `_ai_context/docs/tareas/UJ-03-journey-wp-roto.md` |
| UJ-04 | Journey: reclutador tech → portfolio | DONE (archived) | Recorrido servicios → caso de éxito | `_ai_context/docs/tareas/UJ-04-journey-reclutador.md` |
| UJ-05 | Validar CTA funnel | DONE (archived) | Cada página tiene CTA claro a conversión | `_ai_context/docs/tareas/UJ-05-validar-cta-funnel.md` |
...
|----|--------|--------|-----------|--------------|
| CAT-04 | Verificación build + E2E + navegación | TODO | `/catalogo` 200, 1 h1, 10 tarjetas, filtros jerárquicos, búsqueda, click → detalle, 0 errores JS, nav link | `_ai_context/docs/tareas/FEATURE-2-Catalogo/CAT-04-verificacion-integrar-navegacion.md` |
...
| ID | Título | Estado | Qué cubre | Dónde (spec) |
|----|--------|--------|-----------|--------------|
| DEP-01 | Validación post-deploy (Lighthouse/GA4/form/SSL) | BLOCKED | Lighthouse >80, eventos GTM `GTM-T7PWJ99` (pageview/whatsapp_click/form_submit), formulario contacto, SSL | `_ai_context/docs/tareas/FASE-6-Validacion-post-deploy/DEP-01-post-deploy-validacion.md` |
