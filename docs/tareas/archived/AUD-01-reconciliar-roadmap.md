...
Originalmente, `docs/wiki/Roadmap.md` tenía una contradicción interna:
- La **tabla de estado** marcaba F2 ✅, F3 ✅, F4 ✅, F5 ✅
- El **detalle de fases** marcaba F2 🔄, F3 🔄, F4 ⬜, F5 ⬜

`docs/wiki/Progreso.md` confirmaba que T0-T16 están DONE y las fases cerradas.

**Resolución por migración (AUD-04):** `docs/wiki/` fue eliminada. La información
del rebranding (incluido el estado de fases F0-F5) se migró a
`docs/tareas/HISTORIAL-REBRANDING.md`. Ese archivo ya está reconciliado:
...
Scenario: Historial consistente con el cierre del rebranding
  Given docs/tareas/HISTORIAL-REBRANDING.md es el documento histórico del rebranding
...
1. Verificar `docs/tareas/HISTORIAL-REBRANDING.md`:
...
## Notas
La tarea se resolvió por la migración de AUD-04: `docs/wiki/Roadmap.md` y
`docs/wiki/Progreso.md` ya no existen; su contenido (incluido el estado de
fases F0-F5) vive en `docs/tareas/HISTORIAL-REBRANDING.md`, que ya está
