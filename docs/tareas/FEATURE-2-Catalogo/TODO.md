...
| CAT-02 | Filtros jerárquicos servicio→categoría + búsqueda textual (sin opciones vacías) | DONE   | `docs/tareas/FEATURE-2-Catalogo/CAT-02-filtros-jerarquicos-busqueda.md` |
