...
Originalmente, `docs/wiki/Diseno.md` sección "Tokens y drift pendiente"
...
`docs/tareas/DISENO.md`. En esa migración la sección ya fue reconciliada:
...
Scenario: DISENO.md refleja resolución del drift
  ...
  When un lector abre docs/tareas/DISENO.md
...
1. Verificar `docs/tareas/DISENO.md` sección "Tokens y drift (resuelto — T6)":
...
```bash
#!/bin/bash
# Verificación AUD-03 — DISENO.md (migrado desde docs/wiki/Diseno.md)
# Uso: bash docs/tareas/verify-AUD-03.sh

FILE="docs/tareas/DISENO.md"
...
- Sin "drift pendiente" ni "Acción: elegir" en `docs/tareas/DISENO.md`.
