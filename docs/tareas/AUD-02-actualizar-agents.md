...
2. Actualizar nota de F4: "GTM `GTM-T7PWJ99` activo; pendiente: validar
   eventos con datos reales post-deploy (ver docs/tareas/TODO.md)".
...
apuntando a `docs/tareas/FASE-6-Validacion-post-deploy/DEP-01-post-deploy-validacion.md`). Se ejecutó el verification script:
