...
| Archivo | Descripción |
|---|---|
| `docs/automatizacion/README.md` | Documentación del inicio rápido |
| `docs/automatizacion/docker-compose.yml` | n8n + Postgres + MailHog |
| `docs/automatizacion/init_clientes_db.sql` | Schema DB clientes |
| `docs/automatizacion/.env.example` | Configuración de credenciales |
| `docs/automatizacion/workflows/funnel-generico.json` | Workflow n8n genérico |
| `docs/automatizacion/email_templates/*.html` | 4 templates de email |
| `docs/automatizacion/arquitectura-n8n-automatizacion.md` | Documentación técnica |
| `docs/automatizacion/verify-setup.sh` | Script de verificación |
